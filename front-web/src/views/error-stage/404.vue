<template>
    <div class="body">
        <div class="notfound-copy">
            <div class="d-f-c logo">
                <svg viewBox="230 55 340 160">
                    <path
                        d="M320.1 209.5c0 7.2-6 12.5-13.7 12.5s-13.7-5.4-13.7-12.5v-16.3h-43.8c-8.4 0-14.1-6.4-14.1-13.5 0-.8.8-4.4 2-7L275 84.5c2-4.8 7.2-7.8 12.3-7.8 6.8 0 13.7 6 13.7 12.9 0 1.2 0 2.6-.8 4.4-11.5 26.7-20.9 47.6-32.4 74.2h24.9v-30.4c0-7.2 6-12.5 13.7-12.5 7.4 0 13.7 5.4 13.7 12.5v30.4h2.6c7.6 0 13.3 5.8 13.3 12.3 0 7-5.8 12.5-13.3 12.5h-2.6zm116.8-85.6v54.7c0 24.3-16.3 43.6-46 43.6s-46-19.3-46-43.6v-54.7c0-26.3 13.9-47.4 46-47.4 32.1.1 46 21.2 46 47.4m-64.3-1.4v56.1c0 11.3 6.4 19.1 18.3 19.1s18.3-7.8 18.3-19.1v-56.1c0-12.7-5.2-21.7-18.3-21.7s-18.3 9-18.3 21.7m162.4 87c0 7.2-6 12.5-13.7 12.5s-13.7-5.4-13.7-12.5v-16.3h-43.8c-8.4 0-14.1-6.4-14.1-13.5 0-.8.8-4.4 2-7l38.2-88.2c2-4.8 7.2-7.8 12.3-7.8 6.8 0 13.7 6 13.7 12.9 0 1.2 0 2.6-.8 4.4-11.5 26.7-20.9 47.6-32.4 74.2h24.9v-30.4c0-7.2 6-12.5 13.7-12.5 7.4 0 13.7 5.4 13.7 12.5v30.4h2.6c7.6 0 13.3 5.8 13.3 12.3 0 7-5.8 12.5-13.3 12.5H535z"
                        opacity=".5" fill="#3B3D3D" />
                    <path
                        d="M326.4 197.5c0 7.2-6 12.5-13.7 12.5s-13.7-5.4-13.7-12.5v-16.3h-43.8c-8.4 0-14.1-6.4-14.1-13.5 0-.8.8-4.4 2-7l38.2-88.2c2-4.8 7.2-7.8 12.3-7.8 6.8 0 13.7 6 13.7 12.9 0 1.2 0 2.6-.8 4.4-11.5 26.7-20.9 47.6-32.4 74.2H299v-30.4c0-7.2 6-12.5 13.7-12.5 7.4 0 13.7 5.4 13.7 12.5v30.4h2.6c7.6 0 13.3 5.8 13.3 12.3 0 7-5.8 12.5-13.3 12.5h-2.6zm116.8-85.6v54.7c0 24.3-16.3 43.6-46 43.6s-46-19.3-46-43.6v-54.7c0-26.3 13.9-47.4 46-47.4 32.1.1 46 21.2 46 47.4m-64.2-1.4v56.1c0 11.3 6.4 19.1 18.3 19.1s18.3-7.8 18.3-19.1v-56.1c0-12.7-5.2-21.7-18.3-21.7s-18.3 9-18.3 21.7m162.4 87c0 7.2-6 12.5-13.7 12.5-7.8 0-13.7-5.4-13.7-12.5v-16.3h-43.8c-8.4 0-14.1-6.4-14.1-13.5 0-.8.8-4.4 2-7l38.2-88.2c2-4.8 7.2-7.8 12.3-7.8 6.8 0 13.7 6 13.7 12.9 0 1.2 0 2.6-.8 4.4-11.5 26.7-20.9 47.6-32.4 74.2H514v-30.4c0-7.2 6-12.5 13.7-12.5 7.4 0 13.7 5.4 13.7 12.5v30.4h2.6c7.6 0 13.3 5.8 13.3 12.3 0 7-5.8 12.5-13.3 12.5h-2.6z"
                        fill="#FFF" />
                </svg>
                <h1>网页没找到</h1>
            </div>
            <div class="menu">
                ...
                <div :style="'height:' + finalHeight + 'px'"></div>
                <div class="options">
                    <div class="opt">首页
                    ...
                    <div class="opt" @click="navigate('game')">兔子快跑
                        <svg viewBox="0 0 24 24">
                            <path
                                d="M21,11H5.41l5.3-5.29A1,1,0,1,0,9.29,4.29l-7,7h0a1.15,1.15,0,0,0-.21.33.94.94,0,0,0,0,.76,1.15,1.15,0,0,0,.21.33h0l7,7a1,1,0,0,0,1.42,0,1,1,0,0,0,0-1.42L5.41,13H21a1,1,0,0,0,0-2Z">
                            </path>
                    ...
                    <div class="opt" @click="navigate('login')">登录
                        <svg viewBox="0 0 24 24">
                            <path
                                d="M21,11H5.41l5.3-5.29A1,1,0,1,0,9.29,4.29l-7,7h0a1.15,1.15,0,0,0-.21.33.94.94,0,0,0,0,.76,1.15,1.15,0,0,0,.21.33h0l7,7a1,1,0,0,0,1.42,0,1,1,0,0,0,0-1.42L5.41,13H21a1,1,0,0,0,0-2Z">
                            </path>
        ...
        <svg aria-labelledby="Starry sky" alt="Starry sky" class="starry-sky">
            ...
            <g class="all-stars" fill="#F6F5BC">
                <path class="stars-one"
                    d="M148.9 151.5c-.3-.3-.6-.4-1-.4s-.7.1-1 .4c-1.6 4.9-6.2 6.2-6.2 6.2-.3.3-.4.6-.4 1s.1.7.4 1c4.9 1.6 6.2 6.2 6.2 6.2.3.3.6.4 1 .4s.7-.1 1-.4c1.6-4.9 6.2-6.2 6.2-6.2.3-.3.4-.6.4-1s-.1-.7-.4-1c-5-1.7-6.2-6.2-6.2-6.2zM93.6 100l10 30h-20l10-30z" />
            ...
            <!-- Moon shadow -->
            <g class="moon">
                <path class="light" opacity=".5" fill="#3B3D3D" d="M122.7 373.9L-237.1 744l283.8 269.4 279.9-492.8z" />
                <g class="moon-bg" fill="#D1D5D6">
                    <path
                ...
                <path class="flag-shadow" opacity=".1" fill-rule="evenodd" clip-rule="evenodd" fill="#3B3D3D"
...
const finalHeight = computed(() => {
    if (innerHeight.value > 560) {
        // innerHeight.value 增长的，越大 ，我的间距就要越大
        // return innerHeight.value * 10 / 60
        // 667 -> 0
        // 896 -> 150
        // （667，0），（844，145），（896，150），
        // 150/240
        // 896 - 667 = 229
        // 
        // minOutput + (maxOutput - minOutput) * Math.pow(normalizedInput, exponent)
        return (0.655 * innerHeight.value - 437.485)
    }
...
.starry-sky {
    ...
    .moon {
        .light {
            transform-origin: 219px 468px;
            // transform: rotate(-20deg);
        }

        .moon-bg,
        .moon-pit {
            transform-origin: 211px 467px;
            transform: rotate(20deg);
        }
